...
//        String json = new ObjectMapper().writeValueAsString(mockPackage);
//        mockMvc.perform(post("/package")
//            .contentType(APPLICATION_JSON)
//            .content(json))
//            .andDo(print())
//            .andExpect(jsonPath("$.title", is(mockPackage.getTitle())))
...
//        Package savedPackage = packageRepository.save(mockPackage);
