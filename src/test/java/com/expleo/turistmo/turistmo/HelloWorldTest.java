...
//        }
//
//        MobileElement searchField = driver.findElementByAccessibilityId("searchField");
//        searchField.click();
//        driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
//        searchField.sendKeys("stockholm");
//        MobileElement searchButton = driver.findElementByXPath(
//            "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup[2]/android.widget.Button");
//        searchButton.click();
//        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
//        MobileElement curatorName = driver.findElementByAccessibilityId("curatorName");
//
